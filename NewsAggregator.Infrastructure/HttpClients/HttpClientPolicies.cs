        ...
        public static IAsyncPolicy<HttpResponseMessage> GetResiliencePolicy()
        {
            ...
            var circuitBreakerPolicy = Policy<HttpResponseMessage>
                ...
                .CircuitBreakerAsync(
                    ...
                    {
                        Console.WriteLine($"[BREAKER] Broken for {breakDelay.TotalSeconds}s. Reason: {outcome.Exception?.Message ?? outcome.Result?.StatusCode.ToString()}");
                    },
                    onReset: () => Console.WriteLine("[BREAKER] Reset"),
                    onHalfOpen: () => Console.WriteLine("[BREAKER] Testing half-open"));
            ...
            var retryPolicy = Policy<HttpResponseMessage>
                ...
                .WaitAndRetryAsync(3,
                    ...
                    {
                        Console.WriteLine($"[RETRY] Attempt {retryCount}. Status: {outcome.Result?.StatusCode}");
